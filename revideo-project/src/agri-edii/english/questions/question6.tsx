...
function* question6(view: View2D, videoJson: any) {
  ...
  // const fullText = jsonData.json_response.video.scenes[7].question;
  // const duration = 2;
  ...
  yield* all(
    ...
    chatTxtRef().text(jsonData.json_response.video.scenes[7].question, 2)
  );

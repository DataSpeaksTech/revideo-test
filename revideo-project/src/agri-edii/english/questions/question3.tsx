...
function* question3(view: View2D, videoJson: any) {
  ...
  const fullText = jsonData.json_response.video.scenes[3].question;
  const duration = 2;
  ...
  yield* all(
    ...
    chatTxtRef().text(jsonData.json_response.video.scenes[3].question, 2)
  );
